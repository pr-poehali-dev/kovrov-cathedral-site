...
const cathedrals: Cathedral[] = [
  ...
  },
  {
    ...
    image: 'https://cdn.poehali.dev/projects/4a5696d3-a9fa-4534-80ae-612f84f60c4f/files/8ff41c1f-f6ac-4bc8-aeaf-7b78f7e302fa.jpg',
    shortDescription: 'Деревянная часовня на окраине города',
    yearBuilt: '1870',
    history: 'Покровская часовня была построена в 1870 году жителями окраинной слободы города. Это скромное деревянное строение служило местом молитвы для рабочих местных фабрик. Несмотря на простоту, часовня стала важным духовным центром для простого народа. Сохранилась благодаря бережному отношению местных жителей.',
    architecture: 'Часовня выполнена в традициях деревянного зодчества русского севера. Небольшой объем увенчан шатровой крышей с луковичной главкой. Стены сложены из бревен без гвоздей, по старинной технологии. Резные наличники и крыльцо демонстрируют мастерство народных умельцев. Интерьер отличается простотой и духовной атмосферой.'
  },
  {
    id: 6,
    name: 'Воскресенский собор',
    image: 'https://cdn.poehali.dev/projects/4a5696d3-a9fa-4534-80ae-612f84f60c4f/files/37e2c7ef-a989-4fae-9911-d66dffe7f292.jpg',
    shortDescription: 'Краснокирпичный собор в неовизантийском стиле',
    yearBuilt: '1902',
    history: 'Воскресенский собор был возведён в 1902 году на пожертвования промышленников и купцов города. Это один из последних крупных храмов, построенных до революции. Собор служил кафедральным для Ковровского благочиния. После закрытия в советское время использовался как музей, затем был возвращён церкви и полностью отреставрирован.',
    architecture: 'Собор представляет собой образец неовизантийского стиля начала XX века. Краснокирпичные стены с белокаменными декоративными элементами создают торжественный облик. Центральный купол поднимается на высоту 45 метров. Фасады украшены арочными окнами, пилястрами и майоликовыми панно. Внутри сохранилась уникальная мозаичная роспись.'
  }
];
